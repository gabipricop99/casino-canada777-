                ...
                @if($category->position < 6 && $category->icon)
                    ...
                    <li class="menulist">
                        <a href="{{ route('frontend.game.list.category', $category->href) }}" class="@if($currentSliderNum != -1 && $category->href == $currentSliderNum) active @endif">
                            <img src="https://canada777.com/frontend/Page/image/icon/{{$category->icon}}" alt="">
                            <span class="mt-1">
        ...
        <div class="mobile-top-category-list">
            <table border="0">
                <tr>
                    ...
                    @if ($categories)
                    @foreach($categories as $category)
                    @if($category->position < 6) @if($category->href == 'table')
                        @if(@current_shop_id == $category->shop_id)
                    ...
                    <li>
                        <a href="{{ route('frontend.game.list.category', $category->href) }}" class="@if($currentSliderNum != -1 && $category->href == $currentSliderNum) active @endif">
                            <span class="providers__dropdown-icon">
                                <img class="providers__icon-img" src="https://canada777.com/frontend/Page/image/icon/{{strtolower($category->href)}}.svg">
                            </span>
