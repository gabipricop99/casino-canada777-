				...
				<div class="col-sm-4">
					...
					<div class="btn-group-vertical w-100 payment-button-group">
						<button type="button" class="btn btn-outline-success mb-1 rounded-0">
                            <img src="https://canada777.com/frontend/Default/img/interac-payment-icon.jpg" alt="">
                        </button>
            ...
            <div class="balances">
                <div class="top-balance">
                    <div class="balance">Total Balance
                        <div class="total-balance"><span class="val_type_user_balance">$ <?php echo e(number_format(Auth::user()->balance,2)); ?></span></div>
                    </div>
                    <div class="deposit-btn"><a class="btn btn_action_deposit" href="javascript:fn_profile_load('deposit');"> Deposit</a></div>
                </div>
                <div class="balance">Real Balance <span><span class="val_type_user_balance">$ <?php echo e(number_format(Auth::user()->getRealBalance(),2)); ?></span></span></div>
                <div class="balance">Bonus Balance <span><span class="val_type_user_balance">$ <?php echo e(number_format(Auth::user()->getBonusBalance(),2)); ?></span></span></div>
            </div>
        </div>
