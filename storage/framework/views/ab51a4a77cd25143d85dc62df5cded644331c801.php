<footer id="main_footer">
    ...
    <div class="footer-menu">
        <div class="footer-menu-content d-none d-lg-flex">
            <div class="quick-menu footer-menu-section">
                ...
                <ul>
                    <li><a href="<?php echo e(url('categories/all')); ?>">All Games</a></li>
                    <li><a href="<?php echo e(url('about')); ?>">About Us</a></li>
                    <li><a href="javascript:fn_profile_load('deposit')">Payments</a></li>
                    <li><a href="<?php echo e(url('bonus')); ?>">Promotions</a></li>
                    <li><a href="<?php echo e(url('bonus/term')); ?>">Games Rules</a></li>
                    <li><a href="<?php echo e(url('bonus/term')); ?>">Games Max Limits</a></li>
            ...
            <div class="quick-menu footer-menu-section">
                ...
                <ul>
                    <li><a href="<?php echo e(url('bonus/term')); ?>">Registration Procedure</a></li>
                    <li><a href="<?php echo e(url('bonus/term')); ?>">Terms and Conditions</a></li>
                    <li><a href="<?php echo e(url('bonus/term')); ?>">Bonus Terms</a></li>
                    <li><a href="https://www.privacypolicygenerator.info/live.php?token=5IRscQHRpBtL0PaYXfxiT1RP2t8YTrC4">Privacy Policy</a></li>
                    <li><a href="<?php echo e(url('blog/responsible-gaming')); ?>">Responsible Gaming</a></li>
                    <li><a href="<?php echo e(url('categories/all')); ?>">Complaints</a></li>
                </ul>
            </div>
            <div class="quick-menu footer-menu-section">
                <h5 class="footer-menu-header-text">Games</h5>
                <ul>
                    <li><a href="<?php echo e(url('categories/all')); ?>">Slots</a></li>
                    <li><a href="<?php echo e(url('categories/all')); ?>">Live</a></li>
                    <li><a href="<?php echo e(url('categories/card')); ?>">Card</a></li>
                    <li><a href="<?php echo e(url('categories/card')); ?>">Roulette</a></li>
                    <li><a href="<?php echo e(url('categories/all')); ?>">Jackpot</a></li>
                    <li><a href="<?php echo e(url('categories/new')); ?>">New</a></li>
                    <li><a href="<?php echo e(url('bonus')); ?>">Bonus Buy</a></li>
                </ul>
            </div>
            <div class="quick-menu footer-menu-section">
    ...
    <input type="hidden" id="auth_status" name="auth_status" value=<?php echo e(Auth::check()); ?> />
</footer>
<?php /**PATH C:\khi\00work\06casino\canada777\resources\views/component/frontend/layout/footer.blade.php ENDPATH**/ ?>