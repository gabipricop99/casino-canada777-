                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
								...
								<tr>
									...
									<th><?php echo app('translator')->get('app.game_system'); ?></th>
									...
									<?php if( count($savedCategory) ): ?>
										<?php $__currentLoopData = $savedCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($game_category == 1): ?>
												<th><?php echo app('translator')->get('app.hot_order'); ?></th>
											<?php endif; ?>
											<?php if($game_category == 2): ?>
												<th><?php echo app('translator')->get('app.new_order'); ?></th>
											<?php endif; ?>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									<?php endif; ?>
									<!-- --- -->
								...
								<tbody>
								<?php if(count($games) || count($apigames)): ?>
									...
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
								<?php if(count($apigames)): ?>
									<?php $__currentLoopData = $apigames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apigame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php echo $__env->make('backend.games.partials.apigame_row', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
								<?php if(count($apigames) == 0 && count($apigames) == 0): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\00work\06casino\canada777\resources\views/backend/games/list.blade.php ENDPATH**/ ?>