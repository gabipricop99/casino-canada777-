<body style="margin: 0px;" onClick="fullScreen();">
    <div class="back">
        <!-- GAMES - BEGIN -->
        <img class="back img"/>
        <div class="play" onClick="location.href='/game/<?php echo e($game); ?><?php echo e($prego == '1' ? '/prego' : '/realgo'); ?>';"></div>
...
<?php /**PATH D:\00work\06casino\canada777\resources\views/frontend/Default/games/init.blade.php ENDPATH**/ ?>