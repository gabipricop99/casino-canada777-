    ...
    <div class="game-category-section">
        ...
        <?php if($games && count($games) > 0): ?>
            ...
            <div class="game-item">
                <img
                    class="lazyload"
                    data-src="https://static.canada777.com/frontend/Default/ico/<?php echo e($game->name.'.jpg'); ?>"
...
<?php echo $__env->make('frontend.Default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\khi\00work\06casino\canada777\resources\views/frontend/Default/games/list.blade.php ENDPATH**/ ?>