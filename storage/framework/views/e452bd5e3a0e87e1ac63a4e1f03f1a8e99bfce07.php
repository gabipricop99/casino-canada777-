				...
				<form action="" method="GET" id="users-form" >
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" class="form-control" name="username" value="<?php echo e(Request::get('username')); ?>" placeholder="<?php echo app('translator')->get('app.username'); ?>">
						</div>
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<input type="text" class="form-control" name="email" value="<?php echo e(Request::get('email')); ?>" placeholder="<?php echo app('translator')->get('app.email'); ?>">
						</div>
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.first_name'); ?></label>
							<input type="text" class="form-control" name="first_name" value="<?php echo e(Request::get('first_name')); ?>" placeholder="<?php echo app('translator')->get('app.first_name'); ?>">
						</div>
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.last_name'); ?></label>
							<input type="text" class="form-control" name="last_name" value="<?php echo e(Request::get('last_name')); ?>" placeholder="<?php echo app('translator')->get('app.last_name'); ?>">
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.date_of_birth'); ?></label>
							<input type="text" class="form-control" name="birthday" value="<?php echo e(Request::get('birthday')); ?>" placeholder="<?php echo app('translator')->get('app.date_of_birth'); ?>">
						</div>
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.phone'); ?></label>
							<input type="text" class="form-control" name="phone" value="<?php echo e(Request::get('phone')); ?>" placeholder="<?php echo app('translator')->get('app.phone'); ?>">
						</div>
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.address'); ?></label>
							<input type="text" class="form-control" name="address" value="<?php echo e(Request::get('address')); ?>" placeholder="<?php echo app('translator')->get('app.address'); ?>">
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.city'); ?></label>
							<input type="text" class="form-control" name="city" value="<?php echo e(Request::get('city')); ?>" placeholder="<?php echo app('translator')->get('app.city'); ?>">
						</div>
						<div class="col-md-4">
							<label><?php echo app('translator')->get('app.postal_code'); ?></label>
							<input type="text" class="form-control" name="postalCode" value="<?php echo e(Request::get('postalCode')); ?>" placeholder="<?php echo app('translator')->get('app.postal_code'); ?>">
						</div>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<th><?php echo app('translator')->get('app.last_login_date'); ?></th>
			...
			<div class="modal-content">
				<form action="<?php echo e(route('backend.user.balance.update')); ?>" method="POST">
					<div class="modal-header">
						...
						<h4 class="modal-title"><?php echo app('translator')->get('app.balance'); ?> Edit</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="OutSum"><?php echo app('translator')->get('app.username'); ?></label>
							<input type="text" class="form-control" name="username" placeholder="<?php echo app('translator')->get('app.username'); ?>" disabled>
							<label for="OutSum"><?php echo app('translator')->get('app.balance'); ?></label>
							<input type="text" class="form-control" name="balance" placeholder="<?php echo app('translator')->get('app.balance'); ?>" required>
							<label for="OutSum"><?php echo app('translator')->get('app.bonus'); ?></label>
							<input type="text" class="form-control" name="bonus" placeholder="<?php echo app('translator')->get('app.bonus'); ?>" required>
							<label for="OutSum"><?php echo app('translator')->get('app.wager'); ?></label>
							<input type="text" class="form-control" name="wager" placeholder="<?php echo app('translator')->get('app.wager'); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\00work\06casino\canada777\resources\views/backend/user/list.blade.php ENDPATH**/ ?>