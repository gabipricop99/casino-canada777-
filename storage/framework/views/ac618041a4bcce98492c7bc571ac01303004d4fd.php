<ul class="navigation-bar__list">
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/balance') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point <?php echo e(Request::is('profile/verify') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/deposit') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/withdraw') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-change-password <?php echo e(Request::is('profile/password') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/detail') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/history/*') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/bonus') ? 'active' : ''); ?>">
    ...
    <li class="navigation-bar__point fn-redirect <?php echo e(Request::is('profile/freespin') ? 'active' : ''); ?>">
...
</ul><?php /**PATH C:\khi\00work\06casino\canada777\resources\views/frontend/Default/user/tab.blade.php ENDPATH**/ ?>