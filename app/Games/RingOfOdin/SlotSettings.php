...
namespace VanguardLTE\Games\RingOfOdin
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['SYM_1'] = [0,0,0,2,5,25];
            $this->Paytable['SYM_2'] = [0,0,0,2,5,25];
            $this->Paytable['SYM_3'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_4'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_5'] = [0,0,0,10,15,100];
            $this->Paytable['SYM_6'] = [0,0,5,10,20,150];
            $this->Paytable['SYM_7'] = [0,0,5,15,30,200];
            $this->Paytable['SYM_8'] = [0,0,5,25,50,300];
            $this->Paytable['SYM_9'] = [0,0,0,25,50,300];
            $this->Paytable['SYM_10'] = [0,0,0,0,0,0];
