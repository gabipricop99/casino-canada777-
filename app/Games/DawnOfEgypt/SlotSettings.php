...
namespace VanguardLTE\Games\DawnOfEgypt
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['SYM_1'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_2'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_3'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_4'] = [0,0,0,5,10,50];
            $this->Paytable['SYM_5'] = [0,0,0,10,25,100];
            $this->Paytable['SYM_6'] = [0,0,5,10,25,100];
            $this->Paytable['SYM_7'] = [0,0,5,10,40,200];
            $this->Paytable['SYM_8'] = [0,0,5,15,60,200];
            $this->Paytable['SYM_9'] = [0,0,0,20,100,400];
            $this->Paytable['SYM_10'] = [0,0,0,40,200,1000];
            $this->Paytable['SYM_11'] = [0,0,0,40,200,1000];
            $this->Paytable['SYM_12'] = [0,0,0,50,200,1000];
            $this->Paytable['SYM_13'] = [0,0,0,40,200,1000];
            $this->gambleLadder = [
                0, 
                10, 
                20, 
...
$user->wager = $user->wager + ($sum * $this->game->getCategoryWagerPercent() / 100);
        ...
        public function GenerateFreeSpinSymbolCount(){
            $freeSpins = [
                [70, 25, 5],
                [3, 4, 5]
            ];
        ...
        public function GetFreeSpinCount(){
            $freeSpins = [
        ...
        public function GetReSpinCount(){
            $freeSpins = [
                [60, 30, 10],
                [1, 2, 3]
            ];
        ...
        public function GetFreeSpinWheelPos($col){
            $pos = [2, 14, 2, 0, 12];
            return $pos[$col];
        }
        public function GenerateBonusSymbol(){
            $bonusSymbols = [
                [30, 20, 20, 15 ,10 ,5],
                [4, 5, 6, 7, 8, 9]
            ];
            $percent = rand(0, 100);
            $sum = 0;
            for($i = 0; $i < count($bonusSymbols[0]); $i++){
                $sum = $sum + $bonusSymbols[0][$i];
                if($percent <= $sum){
                    return $bonusSymbols[1][$i];
                }
            }
            return $bonusSymbols[1][0];
        }
        public function GetReelStrips($winType, $slotEvent)
        {
            ...
            if($slotEvent=='freespin'){
                ...
                else
                {
                    ...
                    $scattercount = $this->GenerateFreeSpinSymbolCount();
