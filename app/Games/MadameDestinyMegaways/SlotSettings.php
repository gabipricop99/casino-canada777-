...
namespace VanguardLTE\Games\MadameDestinyMegaways
{
    ...
    class SlotSettings
    {
        ...
        public $reelStrip12_7 = null;
        public $reelStrip13_1 = null;
        public $reelStrip13_2 = null;
        public $reelStrip13_3 = null;
        public $reelStrip13_4 = null;
        public $reelStrip13_5 = null;
        public $reelStrip13_6 = null;
        public $reelStrip13_7 = null;
        public $reelStrip14_1 = null;
        public $reelStrip14_2 = null;
        public $reelStrip14_3 = null;
        public $reelStrip14_4 = null;
        public $reelStrip14_5 = null;
        public $reelStrip14_6 = null;
        public $reelStrip14_7 = null;
...
$user->wager = $user->wager + ($sum * $this->game->getCategoryWagerPercent() / 100);
        ...
        public function GetFreeSpin($index){
            ...
            return $freespins[$index];
        }
        public function GetFreeSpinIndex(){
            $muls = [8,8,8,3,3,3,2,2,7,7,7,2,2,2,1,1,6,6,2,2,1,1,5,5,2,1,1,1];
            $percent = rand(0, 95);
            $sum = 0;
        ...
        public function GenerateScatterCount(){
            $freeSpins = [
                [75, 5, 5, 5],
                [3, 4, 5, 6]
            ];
        ...
        public function GetLastReel($lastReel, $lastBinaryReel){            
            ...
            for($i = 6; $i < 48; $i++){
                ...
                $reels[$i % 6][floor($i / 6)] = $lastReel[$i];
            }
            // for($i = 5; $i >= 0; $i--){
            //     if($lastBinaryReel[$i] > 0){
            //         $lastReel[$i] = -1;
        ...
        public function GetReelStrips($winType, $slotEvent, $slotReelId, $scattercount, $isTumb = false, $lastTumbReelCount = [0, 0, 0, 0, 0, 0])
        {
            ...
            foreach( $_obf_reelStripCounts as $index => $value ) 
            {
                ...
                if($index == 7){
                    ...
                    if($isTumb == true){
                        $symbolCount = $lastTumbReelCount[$index - 1];
                    }else{
