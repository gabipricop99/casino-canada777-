...
namespace VanguardLTE\Games\LegacyOfDead
{
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId, $credits = null)
        {
            ...
            $this->scaleMode = 0;
            $this->numFloat = 0;
            $this->Paytable['SYM_1'] = [0,0,0,5,20,80];
            $this->Paytable['SYM_2'] = [0,0,0,5,20,80];
            $this->Paytable['SYM_3'] = [0,0,0,5,20,80];
            $this->Paytable['SYM_4'] = [0,0,0,5,30,120];
            $this->Paytable['SYM_5'] = [0,0,0,5,30,120];
            $this->Paytable['SYM_6'] = [0,0,5,20,80,600];
            $this->Paytable['SYM_7'] = [0,0,5,20,80,600];
            $this->Paytable['SYM_8'] = [0,0,5,30,300,1600];
            $this->Paytable['SYM_9'] = [0,0,10,100,1000,5000];
