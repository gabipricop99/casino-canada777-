...
namespace VanguardLTE\Games\BurningRingVS
{
    ...
    class Server
    {
        public function get($request, $game, $userId) // changed by game developer
        {
            ...
            \DB::beginTransaction();
            $game_length = strlen($game);
            $isVSPT = ( $game[$game_length - 1] == 'S' && $game[$game_length - 2] == 'V' || $game[$game_length - 1] == 'T' && $game[$game_length - 2] == 'P' );
            $userId = $isVSPT ? 1 : \Auth::id();
            if( $userId == null ) 
            {
            	$userId = 1;
            }
            ...
            $credits = $userId == 1 ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'QRY_CHECK' ? 5000 : $user->balance : null;
