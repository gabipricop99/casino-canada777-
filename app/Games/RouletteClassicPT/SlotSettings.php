    ...
    class SlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
           /* if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            $this->gameLine = [];
            $this->Bet = explode(',', 'minBet=0.5,maxBet=1000,minBetTable=0.5,maxBetTable=1000,minBetStraight=0.5,maxBetStraight=1000,minBetFiftyFifty=0.5,maxBetFiftyFifty=1000,minBetColumnAndDozen=0.1,maxBetColumnAndDozen=1000');
