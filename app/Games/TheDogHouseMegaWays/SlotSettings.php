...
$user->wager = $user->wager + ($sum * $this->game->getCategoryWagerPercent() / 100);
        ...
        public function IsGenerateWild($reelNum = 0, $freeSpinType = 0){
            if($reelNum == 1  || $reelNum == 6){
                return false;
            }
            if($freeSpinType == 1){
                if(rand(0, 100) < 14){
                ...
                if($reelNum == 2 && rand(0, 100) <= 5){  
                    return true;
                }else if($reelNum == 3 && rand(0, 100) <= 7){
                    return true;
                }else if($reelNum == 4 && rand(0, 100) <= 14){
                    return true;
                }else if($reelNum == 5 && rand(0, 100) <= 20){
                    return true;
                }else{
                    return false;
                }
        ...
        public function GenerateFreeSpinCount($scatterCount){
            $freeSpins = [
                [15, 7],
                [18, 12],
                [25, 15],
            ...
            return $freeSpins[$scatterCount - 3];
        }
        ...
        public function GetReelStrips($winType, $slotEvent, $slotReelId, $scattercount)
        {
            ...
            foreach( $_obf_reelStripCounts as $index => $value ) 
            {
                ...
                for($k = 0; $k < $symbolCount; $k++){
                    $reel['reel' . $index][$k] = $key[abs($value + ($k - $scatterPos) * $diffNum) % $rc];
                }
                for($k = $symbolCount; $k < 7; $k++){
                    $reel['reel' . $index][$k] = 14;
                }
